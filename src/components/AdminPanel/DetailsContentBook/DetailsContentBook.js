      ...
      <div className="content flex items-start justify-center mt-5 gap-5 h-[255px]">
        <div className="right">
          ...
          <div className="border-dotted border-gmain border-2 rounded-lg flex flex-col gap-3 mt-4 p-2">
            ...
            <input className="h-10 bg-bg rounded-lg" type="text" disabled />
          </div>
        </div>
        <div className="left">
      ...
      <div className="modal-author">
        ...
        >
          ...
          <div className="modal-middel mt-5">
            ...
            <div className=" content-author bg-gmelo  p-3 flex items-center justify-center flex-wrap  gap-3 rounded-lg">
